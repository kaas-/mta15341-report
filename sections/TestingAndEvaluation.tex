...
\subsection{Technical test}\label{subsec:techtest}
...
\subsection{Analysis}\label{subsec:analysis}\todo{ADD SOMEWHERE THAT BROWN AND BLACK TILES/PIECES LOOK ALIKE!}
