...
This is tested by timing the moment of table contact to the tile colour change in seconds.
...
\end{figure}
	...
	\item \begin{enumerate}
		...
		\begin{enumerate}
				\item The reaction times for each player hand detection were logged.
		\end{enumerate}
	\end{enumerate}
	\item \begin{enumerate}
