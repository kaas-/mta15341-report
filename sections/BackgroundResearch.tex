...
In \citep{peitzWizards2006} Peitz et al. built a board together with RFID antennas and other hardware to detect certain points of the the players' progression. They note some positive things, as aforementioned, namely the increased feeling of togetherness and overall enjoyment. They follow a recipe most traditional board games follow: a tile progression. They simulate this with the dots throughout the map, which the "tokens" press down on and activate. They also note the relationship between wizard and apprentices works well, but note an interesting development in the dynamics when one of the children effectively demotes the adult, who has the role as wizard, and temporarily acts as a new wizard. They did not account for this, but mention it is within their design goals.\todo{Emilie: I'm going to add some stuff to this section, please disregard is comment as it is notes for myself. I will talk about how the commercial competition utilise digital media in different ways. But for the ones that are board games with digital augmentations, the digital element is more of an extra piece sepparate from the board than a physically integrated part of the game. So it feels like you're juggling even more pieces now. We see an unutilised potential there. We can create a product where the digital element is directly integrated in the board game.}
