...
\todo{Daniel demands an addition of some technical further implementation in this subsection}Participants of the usability test described in Section~\ref{ch:testeval} had ideas how to improve the turn taking further, besides improve in its programming. They mentioned that instead of switching player by pressing a hand against the middle of the surface, one should be able to switch turns by interacting with an area specifically only for switching turns. This will require the diffuser to be more evenly illuminated, which could be done by adding more infrared 
