...
\item \textbf{Front Diffused Illumination:} Would have visible light shined from above the touch surface. This would require a glass surface with a diffuser layer. Here the camera senses the shadow created by touches of the surface. This solution requires no compliant surface, no LED frame, no soldering and no enclosed box, which makes it a simple set-up. It can make use of any transparent material and it can track fingers both touching and hovering, since both still creates the shadow needed.
